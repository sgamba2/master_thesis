...
decay, is expected to be of the order of $\mathcal{O}(10^{-54})$. These values 
are far below the sensitivity of current experimental capabilities. However, several 
models of physics beyond the Standard Model predict a much higher relative rate, potentially 
reaching an observable level in certain supersymmetry scenarios. The SINDRUM II experiment 
set an upper limit on muon conversion at $7 \times 10^{-13}$ (90\% C.L.) 
\cite{SINDRUMII:2006dvw}, and the Mu2e collaboration aims to improve this limit by 
four orders of magnitude. Observing this process would provide clear evidence of physics 
...
beam from Fermilab strikes a tungsten target, producing muons through pion decays. These 
particles are transported via a series of superconducting solenoids to an aluminum 
...
calorimeter, a Cosmic Ray Veto, and a Stopping Target Monitor.
...
To minimize energy loss, a straw tube tracker will be used \cite{bobbb}. Its 
...
This Thesis presents a comprehensive study of the Mu2e tracker system, 
...
are generated during nuclear recoil processes. Delta rays, or secondary 
ionized electrons, are produced when high-energy charged particles collide 
...
position resolution better than 4 cm. This involves determining signal 
