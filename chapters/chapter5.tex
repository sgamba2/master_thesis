...
In the simulation, 2$\times 10^8$ cosmic muons were generated on the horizontal plane. From this number, it is possible to compute the time required for calibration, that is
