...
Considering a generation plane of $\sim 5$ m$^2$, the result is a rate of generated cosmics of $R \sim 380$ Hz at $\sim$11 m to the ground. 
...
In the simulation, the number of generated cosmic muons was 2$\times 10^8$ on the generation plan (and only $10^5$ effectively hit the first station).
From these number it is possible to compute how much time is needed for the calibration: 
