...
impact was negligible.
  ...
  \begin{figure}[!h]
      ...
      \caption{digi-FPGA-1: histogram of the delay between 
    ...
    \begin{figure}[!h]
      ...
      \caption{digi-FPGA-2: histogram of the delay between 
...
\section{Study of preamplifiers performance and an 
initial approach to Data Quality Monitoring}\label{dqm}
...
\begin{figure}[!h]
  ...
  preamplifier boards installed. The distance between 
...
\begin{figure}[!h]
      ...
      \caption{The (Positive) charge distribution of the waveforms (channel 66).}
      \label{fig:ch1}
  \end{figure}
...
\begin{figure}[!h]
  ...
  \caption{The pulse height distribution of the waveforms (channel 66).}
  \label{fig:ph2}
\end{figure}
...
\begin{figure}[!h]
  ...
  \caption{The first sample distribution of the waveforms (channel 66).}
  \label{fig:fs2}
\end{figure}
...
\begin{figure}[!h]
    ...
    \caption{The negative charge distribution of the waveforms (channel 66).}
    \label{fig:nch2}
\end{figure}
...
\begin{figure}[!h]
  ...
  \caption{2D distribution of pulse height versus (positive) charge.}
  \label{fig:chvsph}
\end{figure}
To understand the origin of this pattern, the 
...
\begin{figure}[!h]
  ...
  \caption{The distribution of the waveform mean sample weighted with the (positive) charge (channel 66).}
  \label{fig:smean}
\end{figure}
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.65\textwidth]{figures/pdf/chtmean.pdf}
  \caption{2D distribution of (positive) charge versus $s_{mean}$.}
  \label{fig:chtm}
\end{figure}
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.65\textwidth]{figures/pdf/phtmean1.pdf}
  \caption{2D distribution of pulse height versus $s_{mean}$.}
  \label{fig:phtm}
\end{figure}
