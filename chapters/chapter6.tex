\chapter{Design of the tracker station calibration}\label{planning}
...
To ensure optimal performance, it's essential to conduct the initial calibration with the system in a vertical orientation. 
...
\begin{figure}[!h]
    ...
    \caption[Illumination of Monte Carlo hits on panel 0, plane 0.]{Illumination of Monte Carlo hits on panel 0, plane 0, selecting cosmics that traverse at 
...
\begin{figure}[!h]
    ...
    \caption[Schematic view of a cosmic muon hitting the vertical oriented station.]{Schematic view of a cosmic muon (light blue) hitting the vertical oriented station. The red lines are the $ComboHit$s, the dark blue dots 
