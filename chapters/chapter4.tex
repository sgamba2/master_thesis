...
The second one describes the initial data quality monitoring of the tracker preamps. 
  ...
  followed by the event readout.
    ...
    select one between the two ROC operational modes:
    \begin{itemize}
    ...
    that represents the distance between the two consecutive 
    proton pulses (called Event Window Markers-EWM), 
    separated by 
...
Figure \ref{fig:2} (Bottom) zooms in on the 
