...
Since the preamps are mounted vertically, and channel 0 is the one on the board, the cross talk appears to be of radiative type. 
Additionally, it seems to occur only in the first 20 channels, which correspond to the longest straws and will be placed in the middle of the station.
The space between the preamps of the first channels is narrower compared to the others. This seems to be the reason why it 
happens only in the first channels. This behaviour was reported to the tracker panel experts, and they are still working on it. XXX
\begin{figure}[!h]
  \centering
