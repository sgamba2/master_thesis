...
\subsection{Pre-Amplifiers}\label{preampss}
...
\subsection{DRAC: Digitizer Readout and Assembler Controller}\label{DRAC}
...
\subsection{Tracker Data Acquisition}\label{tdaqtra}
