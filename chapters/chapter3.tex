...
\begin{figure}[!h]
    ...
    \caption[The total simulated drift time versus the initial radial distance from the
    sense wire.]{The total simulated drift time as a function of initial radial distance from the
