...
\begin{equation}
    ln(G)=\beta a E(a) ln\left( \frac{E(a)}{E_{min}}\right)
\end{equation}
...
$\beta=ln(2)/\Delta V$, so the gain in a drift tube is:
\begin{equation}
    ln(G)=\frac{ln(2)}{\Delta V} a E(a) ln\left( \frac{E(a)\rho_0}{E_{min}(\rho_0)\rho}\right) \qquad E(a)=\frac{V}{a ln(b/a)}
\end{equation}
