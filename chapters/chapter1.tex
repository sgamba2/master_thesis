...
determines the relative strengths of the two operators. The first term, called dipole term, in the Lagrangian represents a
...
is dominant. Since both backgrounds scale with the muon stop rate $\Gamma_\mu$, a continuous beam is preferred. 
...
Thanks to the one particle final state, this channel is not affected by accidental
