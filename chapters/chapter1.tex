...
\hline
\end{tabular}
\caption[Lepton numbers assigned to neutrinos and charged leptons.]{Lepton numbers assigned to neutrinos and charged leptons.}
...
\hline
\end{tabular}
\caption[Upper limits for the CLFV processes of leptons, mesons and heavy bosons.]{Experimental upper limits for a variety of CLFV processes of leptons, mesons and heavy bosons, Ref. \cite{clfv_signorelli}.}
...
The corresponding parameter space (the $\Gamma-\kappa$ plane) is shown in 
...
Negative muons are captured by a nucleus and the decay products are detected. The coherent conversion leaves the nucleus
