...
In a $hollow$-shaped experimental setup, the background from low-momentum particles can be reduced to manageable levels.
...
However, the search is affected by the   
short $\tau$ lifetime  
