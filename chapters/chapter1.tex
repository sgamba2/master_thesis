...
duplicates for every family of elementary fermions, was implemented within the Standard Model by introducing 
...
\end{table}
\end{center}
In the \del{Standard Model} SM defined with massless 
...
of the conservation of the lepton flavour. The Standard Model, 
...
\del{so}\add{and} the expected branching ratios \del{reach unmeasurable values,} 
below $10^{-50}$ \add{are well beyond the experimental reach}. Experimental studies 
...
Minor deviations from the Standard Model can easily give rise to extra 
occurrences of lepton flavour violation, leading to notable rates of CLFV.
There are various extensions of the Standard Model that could potentially 
...
I will call the left-handed $i$-th quarks doublets and 
leptons doublets as $Q_{L,i}=(u_{L,i} \ d_{L,i})^T$ and 
$L_{L,i}=(\nu_{L,i} \ e_{L,i})^T$: $u_i$ \del{will be}\add{is} 
the up-type quark, $d_i$ the down-type quark, $\nu_i$ the neutrino, 
and $e_i$ the charged lepton. These are $SU(2)$ doublets, while 
$u_{R,j}$, $d_{R,j}$ and $e_{R,j}$ will be the right-handed 
up-type, down-type quarks and the right charged lepton of the 
$j$-th generation respectively. There is no right-handed 
neutrino\add{s}. The Yukawa coupling of fermions with the Higgs 
field $\mathscr{L}_Y$ is the sum of two terms: $\mathscr{L}_e$ 
that describes the leptonic component (Eq.\ref{leptoniccomponent}) 
and $\mathscr{L}_q$ that describes the quark one (Eq.\ref{quarkcomponent}).
