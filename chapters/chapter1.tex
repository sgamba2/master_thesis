...
where the term $Y_f \ (f  =  u,d,e)$ describe the 3$\times$3 
...
scale $\Gamma$ as a function of $\kappa$ as defined in Equation \ref{LCF}, \cite{CGroup:2022tli}. The blue region is the New
